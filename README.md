...
The Android version uses Gradle to get the Fabric SDK (`io.fabric.tools:gradle:1.2.7`) and the Crashlytics SDK (`com.crashlytics.sdk.android:crashlytics:2.9.1`) from Maven repositories when the plugin is added.
